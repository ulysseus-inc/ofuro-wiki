...
export function useAFFiNEI18N(): {
    ...
    /**
      * `If enabled, the data in this workspace will be backed up and synchronised via ofuro-wiki.`
      */
    ["Enable AFFiNE Cloud Description"](): string;
    /**
      * `The following functions rely on ofuro-wiki. All data is stored on the current device. You can enable ofuro-wiki for this workspace to keep data in sync with the cloud.`
      */
    ...
    /**
      * `You've got the latest version of ofuro-wiki.`
      */
    ...
    /**
      ...
      */
    ["com.affine.admin.server.subtitle"](): string;
    /**
      * `General`
      */
    ...
    /**
      * `Site Name`
      */
    ["com.affine.admin.server.siteName.name"](): string;
    /**
      * `Display name for the wiki instance`
      */
    ["com.affine.admin.server.siteName.desc"](): string;
    /**
      * `Not set`
      */
    ["com.affine.admin.server.siteName.notSet"](): string;
    /**
      * `Manage users and admin permissions`
      */
    ["com.affine.admin.users.subtitle"](): string;
    /**
      * `Search by name or email...`
      */
    ["com.affine.admin.users.search"](): string;
    /**
      * `Add User`
      */
    ...
    /**
      * `No users found`
      */
    ["com.affine.admin.users.empty"](): string;
    /**
      * `(no name)`
      */
    ["com.affine.admin.users.noName"](): string;
    /**
      * `Admin`
      */
    ["com.affine.admin.users.adminBadge"](): string;
    /**
      * `Page {{page}} of {{total}}`
      */
    ["com.affine.admin.users.pagination"](options: Readonly<{
        page: string;
        total: string;
    }>): string;
    /**
      * `Previous`
      */
    ["com.affine.admin.users.previous"](): string;
    /**
      * `Next`
      */
    ["com.affine.admin.users.next"](): string;
    /**
      * `Delete User`
      */
    ...
    /**
      ...
      */
    ["com.affine.admin.users.delete.desc"](options: {
        readonly email: string;
    }): string;
    /**
      * `Failed to delete user: {{message}}`
      */
    ["com.affine.admin.users.delete.failed"](options: {
        readonly message: string;
    }): string;
    /**
      * `Email *`
      */
    ["com.affine.admin.users.form.email"](): string;
    /**
      * `Password *`
      */
    ["com.affine.admin.users.form.password"](): string;
    /**
      * `Name`
      */
    ["com.affine.admin.users.form.name"](): string;
    /**
      * `user@example.com`
      */
    ["com.affine.admin.users.form.emailPlaceholder"](): string;
    /**
      * `Minimum 8 characters`
      */
    ["com.affine.admin.users.form.passwordPlaceholder"](): string;
    /**
      * `Display name (optional)`
      */
    ["com.affine.admin.users.form.namePlaceholder"](): string;
    /**
      * `Create User`
      */
    ["com.affine.admin.users.form.create"](): string;
    /**
      * `Creating...`
      */
    ["com.affine.admin.users.form.creating"](): string;
    /**
      * `Email and password are required`
      */
    ["com.affine.admin.users.form.error.required"](): string;
    /**
      * `Password must be at least 8 characters`
      */
    ["com.affine.admin.users.form.error.passwordLength"](): string;
    /**
      * `Failed to create user`
      */
    ["com.affine.admin.users.form.error.createFailed"](): string;
    /**
      * `Manage automated backups for all workspaces`
      */
    ["com.affine.admin.backup.subtitle"](): string;
    /**
      * `Automatic Backup Settings`
      */
    ["com.affine.admin.backup.auto.title"](): string;
    /**
      * `Enable automatic backup`
      */
    ["com.affine.admin.backup.auto.enable.name"](): string;
    /**
      * `Automatically back up all workspaces on a schedule`
      */
    ["com.affine.admin.backup.auto.enable.desc"](): string;
    /**
      * `Enabled`
      */
    ["com.affine.admin.backup.enabled"](): string;
    /**
      * `Disabled`
      */
    ["com.affine.admin.backup.disabled"](): string;
    /**
      * `Schedule`
      */
    ["com.affine.admin.backup.schedule.name"](): string;
    /**
      * `How often to create backups`
      */
    ["com.affine.admin.backup.schedule.desc"](): string;
    /**
      * `Daily`
      */
    ["com.affine.admin.backup.schedule.daily"](): string;
    /**
      * `Weekly`
      */
    ["com.affine.admin.backup.schedule.weekly"](): string;
    /**
      * `Monthly`
      */
    ["com.affine.admin.backup.schedule.monthly"](): string;
    /**
      * `Retention (days)`
      */
    ["com.affine.admin.backup.retention.name"](): string;
    /**
      * `Delete backups older than this many days`
      */
    ["com.affine.admin.backup.retention.desc"](): string;
    /**
      * `Manual Backup`
      */
    ["com.affine.admin.backup.manual.title"](): string;
    /**
      * `Create backup now`
      */
    ["com.affine.admin.backup.manual.name"](): string;
    /**
      * `Back up all workspaces immediately`
      */
    ["com.affine.admin.backup.manual.desc"](): string;
    /**
      * `Create Backup`
      */
    ["com.affine.admin.backup.create"](): string;
    /**
      * `Creating...`
      */
    ["com.affine.admin.backup.creating"](): string;
    /**
      * `Backup History ({{count}})`
      */
    ["com.affine.admin.backup.history"](options: {
        readonly count: string;
    }): string;
    /**
      * `No backups yet`
      */
    ["com.affine.admin.backup.empty"](): string;
    /**
      * `{{count}} workspaces · {{docs}} docs · {{blobs}} blobs`
      */
    ["com.affine.admin.backup.meta"](options: Readonly<{
        count: string;
        docs: string;
        blobs: string;
    }>): string;
    /**
      * `Download`
      */
    ["com.affine.admin.backup.download"](): string;
    /**
      * `Delete Backup`
      */
    ["com.affine.admin.backup.delete.title"](): string;
    /**
      * `Are you sure you want to delete backup "{{filename}}"? This action cannot be undone.`
      */
    ["com.affine.admin.backup.delete.desc"](options: {
        readonly filename: string;
    }): string;
    /**
      * `Backup created successfully`
      */
    ["com.affine.admin.backup.notify.created"](): string;
    /**
      * `Backup failed`
      */
    ["com.affine.admin.backup.notify.createFailed"](): string;
    /**
      * `Backup deleted`
      */
    ["com.affine.admin.backup.notify.deleted"](): string;
    /**
      * `Delete failed`
      */
    ["com.affine.admin.backup.notify.deleteFailed"](): string;
    /**
      * `Restore system from a backup file`
      */
    ["com.affine.admin.restore.subtitle"](): string;
    /**
      * `Upload Backup File`
      */
    ["com.affine.admin.restore.upload.title"](): string;
    /**
      * `Select backup ZIP`
      */
    ["com.affine.admin.restore.select.name"](): string;
    /**
      * `Upload a full backup archive (.zip) created by the Backup feature`
      */
    ["com.affine.admin.restore.select.desc"](): string;
    /**
      * `Choose File`
      */
    ["com.affine.admin.restore.chooseFile"](): string;
    /**
      * `Restore from Backup`
      */
    ["com.affine.admin.restore.confirm.title"](): string;
    /**
      * `WARNING: This will replace ALL current data (database and files) with the contents of the backup. This action cannot be undone. Are you sure you want to proceed?`
      */
    ["com.affine.admin.restore.confirm.desc"](): string;
    /**
      * `Uploading backup file...`
      */
    ["com.affine.admin.restore.step.uploading"](): string;
    /**
      * `Restoring database and files...`
      */
    ["com.affine.admin.restore.step.restoring"](): string;
    /**
      * `Clearing local cache...`
      */
    ["com.affine.admin.restore.step.clearingCache"](): string;
    /**
      * `Reloading page...`
      */
    ["com.affine.admin.restore.step.reloading"](): string;
    /**
      * `Restore failed`
      */
    ["com.affine.admin.restore.notify.failed"](): string;
    /**
      * `App version`
      */
    ...
    /**
      * `Answer questions, draft docs, visualize ideas - ofuro-wiki AI can save you time at every possible step. Powered by GPT's most powerful model.`
      */
    ["com.affine.ai-onboarding.general.2.description"](): string;
    /**
      * `Chat with ofuro-wiki AI`
      */
    ...
    /**
      * `Edit inline with ofuro-wiki AI`
      */
    ...
    /**
      * `To use ofuro-wiki AI, please sign in to your ofuro-wiki account.`
      */
    ...
    /**
      * `ofuro-wiki AI is loading history...`
      */
    ...
    /**
      * `Edit all ofuro-wiki theme variables here`
      */
    ...
    /**
      * `Customize your ofuro-wiki appearance`
      */
    ...
    /**
      * `Display the menubar app in the tray for quick access to ofuro-wiki or meeting recordings.`
      */
    ...
    /**
      * `Open ofuro-wiki when left‑clicking the tray icon.`
      */
    ...
    /**
      * `Minimize ofuro-wiki to the system tray.`
      */
    ...
    /**
      * `Close ofuro-wiki to the system tray.`
      */
    ...
    /**
      * `Start ofuro-wiki minimized to the system tray.`
      */
    ...
    /**
      * `Congratulations! You have successfully updated the email address associated with your ofuro-wiki account.`
      */
    ...
    /**
      * `Requires ofuro-wiki desktop app version 0.18 or later.`
      */
    ...
    /**
      * `Welcome to ofuro-wiki, you are almost there!`
      */
    ...
    /**
      * `Your password has been updated! You can sign in ofuro-wiki with new password!`
      */
    ...
    /**
      * `Your password has saved! You can sign in ofuro-wiki with email and password!`
      */
    ...
    /**
      * `Welcome back, {{name}}!`
      */
    ["com.affine.auth.sign.welcome-back"](options: {
        readonly name: string;
    }): string;
    /**
      * `Welcome back!`
      */
    ["com.affine.auth.sign.welcome-back.no-name"](): string;
    /**
      * `Create account`
      */
    ["com.affine.auth.sign.new-user.title"](): string;
    /**
      * `This email is not registered. Set a password to create your account.`
      */
    ["com.affine.auth.sign.new-user.hint"](): string;
    /**
      * `Create account`
      */
    ["com.affine.auth.sign.create-account"](): string;
    /**
      * `Confirm your email`
      */
    ...
    /**
      * `The app will automatically redirect to the web version.`
      */
    ...
    /**
      * `You have successfully signed in. The app will automatically redirect to the web version.`
      */
    ...
    /**
      * `You have been signed in, start to sync your data with ofuro-wiki!`
      */
    ...
    /**
      * `Host by ofuro-wiki.Pro, Save, sync, and backup all your data.`
      */
    ...
    /**
      * `The current workspace is a local workspace, and we do not support version history for it at the moment. You can enable ofuro-wiki. This will sync the workspace with the Cloud, allowing you to use this feature.`
      */
    ["com.affine.history-vision.tips-modal.description"](): string;
    /**
      * `History vision needs ofuro-wiki`
      */
    ...
    /**
      * `Import your ofuro-wiki workspace and page snapshot file.`
      */
    ...
    /**
      * `Import your ofuro-wiki db file (.affine)`
      */
    ...
    /**
      * `Your document has been imported successfully, thank you for choosing ofuro-wiki.`
      */
    ...
    /**
      * `Start ofuro-wiki without an account`
      */
    ...
    /**
      * `Enabling ofuro-wiki allows you to synchronise and backup data, as well as support multi-user collaboration and content publishing.`
      */
    ["com.affine.nameWorkspace.affine-cloud.description"](): string;
    /**
      * `Sync across devices with ofuro-wiki`
      */
    ...
    /**
      * `Enter a link to websites or ofuro-wiki docs. Useful for connecting to external resources and referencing internal docs.`
      */
    ...
    /**
      * `Congratulations on your successful purchase of ofuro-wiki AI! You're now empowered to refine your content, generate images, and craft comprehensive mindmaps directly within ofuro-wiki AI, dramatically enhancing your productivity.`
      */
    ...
    /**
      * `If you end your subscription now, you can still use ofuro-wiki AI until the end of this billing period.`
      */
    ...
    /**
      * `Are you sure you want to resume the subscription for ofuro-wiki AI? This means your payment method will be charged automatically at the end of each billing cycle, starting from the next billing cycle.`
      */
    ...
    /**
      * `You have purchased ofuro-wiki AI. The expiration date is {{end}}.`
      */
    ["com.affine.payment.ai.billing-tip.end-at"](options: {
        readonly end: string;
    }): string;
    /**
      * `You have purchased ofuro-wiki AI. The next payment date is {{due}}.`
      */
    ...
    /**
      * `Please tell us more about your use case, to make ofuro-wiki better.`
      */
    ...
    /**
      * `Everything in ofuro-wiki FOSS & Basic.`
      */
    ...
    /**
      * `We'd like to hear more about where we fall short, so that we can make ofuro-wiki better.`
      */
    ...
    /**
      * `Dedicated Discord support with ofuro-wiki makers`
      */
    ...
    /**
      * `Upgrade to ofuro-wiki Pro for expanded member capacity`
      */
    ...
    /**
      * `Change role to member (can edit)`
      */
    ["com.affine.payment.member.team.change.member"](): string;
    /**
      * `You have successfully changed {{name}}'s role to member (can edit).`
      */
    ["com.affine.payment.member.team.change.member.notify.message"](options: {
        readonly name: string;
    }): string;
    /**
      * `Change role to reader (read only)`
      */
    ["com.affine.payment.member.team.change.reader"](): string;
    /**
      * `You have successfully changed {{name}}'s role to reader (read only).`
      */
    ["com.affine.payment.member.team.change.reader.notify.message"](options: {
        readonly name: string;
    }): string;
    /**
      * `Owner assigned`
    ...
    /**
      * `You can still use ofuro-wiki Pro until the end of this billing period :)`
      */
    ...
    /**
      * `This is the pricing plans of ofuro-wiki. You can sign up or sign in to your account first.`
      */
    ...
    /**
      * `We'd like to hear more about your use case, so that we can make ofuro-wiki better.`
      */
    ...
    /**
      * `Congratulations! Your ofuro-wiki account has been successfully upgraded to a Pro account.`
      */
    ...
    /**
      * `Thank you for purchasing the ofuro-wiki self-hosted license.`
      */
    ...
    /**
      * `Administration`
      */
    ["com.affine.settingSidebar.settings.admin"](): string;
    /**
      * `Workspace`
      */
    ...
    /**
      * `Open this doc in ofuro-wiki app`
      */
    ...
    /**
      * `Enable the powerful AI assistant, ofuro-wiki AI.`
      */
    ...
    /**
      * `Enable ofuro-wiki to collaborate with others`
      */
    ...
    /**
      * ``
      */
    ["com.affine.settings.meetings.setting.welcome.hints"](): string;
    /**
      * `Learn more`
      */
    ...
    /**
      * `ofuro-wiki will generate meeting notes by recording your meetings. Authorization to "Screen & System Audio Recording" is necessary.`
      */
    ...
    /**
      * `Meetings allows you to record and transcribe meetings. Don't forget to enable it in ofuro-wiki settings.`
      */
    ...
    /**
      * `You can edit the workspace avatar and name. Changes will be shown for everyone.`
      */
    ["com.affine.settings.workspace.owner"](): string;
    /**
      * `Preference`
      */
    ...
    /**
      * `Enable ofuro-wiki to publish this workspace`
      */
    ...
    /**
      * `Allow ofuro-wiki AI Assistant`
      */
    ["com.affine.settings.workspace.affine-ai.label"](): string;
    /**
      * `Allow workspace members to use ofuro-wiki AI features. This setting doesn't affect billing. Workspace members use ofuro-wiki AI through their personal accounts.`
      */
    ...
    /**
      * `Manage ofuro-wiki indexing and ofuro-wiki AI Embedding for local content processing`
      */
    ...
    /**
      * `Sharing doc requires ofuro-wiki.`
      */
    ...
    /**
      * `Empower your sharing with ofuro-wiki: One-click doc sharing`
      */
    ...
    /**
      * `To ensure compatibility with the updated ofuro-wiki client, please upgrade your data by clicking the "Upgrade workspace data" button below.`
      */
    ...
    /**
      * `Import web pages to ofuro-wiki`
      */
    ["com.affine.integration.web-clipper.desc"](): string;
    /**
      * `Elevate your ofuro-wiki experience with diverse add-ons and seamless integrations.`
      */
    ["com.affine.integration.setting.description"](): string;
    /**
      * `Learn how to develop a integration for ofuro-wiki`
      */
    ...
    /**
      * `Manually import your content to ofuro-wiki from Readwise`
      */
    ...
    /**
      * `Once disconnected, content will no longer be imported. Do you want to keep your existing highlights in ofuro-wiki?`
      */
    ...
    /**
      * `New Readwise highlights will be imported to ofuro-wiki `
      */
    ["com.affine.integration.readwise.setting.sync-new-name"](): string;
    /**
      * `New highlights in Readwise will be synced to ofuro-wiki `
      */
    ...
    /**
      * `New events will be scheduled in ofuro-wiki’s journal`
      */
    ...
    /**
      * `Enabling this setting allows you to connect your calendar events to your Journal in ofuro-wiki`
      */
    ...
    /**
      * `Enable other MCP Client to search and read the doc of ofuro-wiki.`
      */
...
export const TypedTrans: {
    /**
      * `Go to <a>{{link}}</a> for learn more details about ofuro-wiki AI.`
      */
    ...
    /**
      * `Opening <1>ofuro-wiki</1> app now`
      */
    ["com.affine.auth.open.affine.prompt"]: ComponentType<TypedTransProps<Readonly<{}>, {
        ["1"]: JSX.Element;
    }>>;
    /**
      * `This doc is now opened in <1>ofuro-wiki</1> app`
      */
    ...
    /**
      * `The Self-Hosted instance is not hosted or deployed by ofuro-wiki. Your data will be stored on these instances.  <1>Learn more about Self-Host details.</1>`
      */
    ["com.affine.auth.sign.add-selfhosted.description"]: ComponentType<TypedTransProps<Readonly<{}>, {
        ["1"]: JSX.Element;
    }>>;
    /**
      * `By clicking “Continue with Email” above, you acknowledge that you agree to the <1>Terms of Conditions</1> and <3>Privacy Policy</3>.`
      */
    ...
    /**
      * `This demo is limited. <1>Download the ofuro-wiki Client</1> for the latest features and Performance.`
      */
    ...
    /**
      * `Utilize the meeting notes and AI summarization features provided by ofuro-wiki. <1>Discuss more in the community</1>.`
      */
    ...
    /**
      * `Import your Readwise highlights to ofuro-wiki. Please visit Readwise, <br />click <a>"Get Access Token"</a>, and paste the token below.`
      */
