import { useDocMetaHelper } from '@ofuro/core/components/hooks/use-block-suite-page-meta';
import { useDocCollectionPage } from '@ofuro/core/components/hooks/use-block-suite-workspace-page';
import { FetchService, GraphQLService } from '@ofuro/core/modules/cloud';
import {
  type WorkspaceFlavourProvider,
  WorkspaceService,
  WorkspacesService,
} from '@ofuro/core/modules/workspace';
import { WorkspaceImpl } from '@ofuro/core/modules/workspace/impls/workspace';
import { DebugLogger } from '@ofuro/debug';
import type { ListHistoryQuery } from '@ofuro/graphql';
import { listHistoryQuery, recoverDocMutation } from '@ofuro/graphql';
import { i18nTime } from '@ofuro/i18n';
