...
import { AuthService } from '@ofuro/core/modules/cloud/services/auth';
import { type DocCommentEntity } from '@ofuro/core/modules/comment/entities/doc-comment';
import { CommentPanelService } from '@ofuro/core/modules/comment/services/comment-panel-service';
import { DocCommentManagerService } from '@ofuro/core/modules/comment/services/doc-comment-manager';
import type {
  CommentAttachment,
  DocComment,
  DocCommentReply,
} from '@ofuro/core/modules/comment/types';
import { DocService } from '@ofuro/core/modules/doc';
import { toDocSearchParams } from '@ofuro/core/modules/navigation';
