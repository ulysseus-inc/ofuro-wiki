...
import { OAuth } from '@ofuro/core/components/affine/auth/oauth';
...
export const SignInStep = ({
  ...
  const onContinue = useAsyncCallback(async () => {
    ...
    try {
      const { hasPassword, registered, name } = await authService.checkUserByEmail(email);
          ...
          <>
            <div className={style.authMessage}>
              ...
              <Trans i18nKey="com.affine.auth.sign.message">
                ...
                you agree to ofuro-wiki&apos;s <a href="/terms" target="_blank" rel="noreferrer">Terms of Conditions</a> and <a href="https://www.ulysseus.co.jp/privacy" target="_blank" rel="noreferrer">Privacy Policy</a>.
            </Trans>
            </div>
