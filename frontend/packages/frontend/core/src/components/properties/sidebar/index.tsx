import { Divider, IconButton, Tooltip } from '@ofuro/component';
import type { DocCustomPropertyInfo } from '@ofuro/core/modules/db';
import {
  WorkspacePropertyService,
  type WorkspacePropertyType,
} from '@ofuro/core/modules/workspace-property';
import { generateUniqueNameInSequence } from '@ofuro/core/utils/unique-name';
