...
import { FavoriteButton } from '@ofuro/core/blocksuite/block-suite-header/favorite';
import { InfoButton } from '@ofuro/core/blocksuite/block-suite-header/info';
import { JournalWeekDatePicker } from '@ofuro/core/blocksuite/block-suite-header/journal/date-picker';
import { JournalTodayButton } from '@ofuro/core/blocksuite/block-suite-header/journal/today-button';
import { PageHeaderMenuButton } from '@ofuro/core/blocksuite/block-suite-header/menu';
import { DetailPageHeaderPresentButton } from '@ofuro/core/blocksuite/block-suite-header/present/detail-header-present-button';
...
import { useRegisterCopyLinkCommands } from '@ofuro/core/components/hooks/affine/use-register-copy-link-commands';
import { HeaderDivider } from '@ofuro/core/components/pure/header';
...
import { SharePageButton } from '@ofuro/core/modules/share-menu';
import { TemplateDocService } from '@ofuro/core/modules/template-doc';
import { ViewIcon, ViewTitle } from '@ofuro/core/modules/workbench';
