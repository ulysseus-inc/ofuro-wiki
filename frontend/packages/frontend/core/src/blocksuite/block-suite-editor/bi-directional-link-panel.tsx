...
} from '@ofuro/core/blocksuite/view-extensions/editor-view/reference-renderer';
...
import {
  ...
  DocLinksService,
  type Link,
} from '@ofuro/core/modules/doc-link';
import { toDocSearchParams } from '@ofuro/core/modules/navigation/utils';
import { GlobalSessionStateService } from '@ofuro/core/modules/storage';
