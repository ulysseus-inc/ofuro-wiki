import { notify, toast, useConfirmModal } from '@ofuro/component';
import {
  Menu,
  MenuItem,
  MenuSeparator,
  MenuSub,
} from '@ofuro/component/ui/menu';
import { PageHistoryModal } from '@ofuro/core/components/affine/page-history-modal';
import { useGuard } from '@ofuro/core/components/guard';
import { useBlockSuiteMetaHelper } from '@ofuro/core/components/hooks/affine/use-block-suite-meta-helper';
...
import { Export, MoveToTrash } from '@ofuro/core/components/page-list';
import { IsFavoriteIcon } from '@ofuro/core/components/pure/icons';
import { useDetailPageHeaderResponsive } from '@ofuro/core/desktop/pages/workspace/detail-page/use-header-responsive';
import { WorkspaceDialogService } from '@ofuro/core/modules/dialogs';
import { EditorService } from '@ofuro/core/modules/editor';

import { GuardService } from '@ofuro/core/modules/permissions';
import { ShareMenuContent } from '@ofuro/core/modules/share-menu';
import { WorkbenchService } from '@ofuro/core/modules/workbench';
import { ViewService } from '@ofuro/core/modules/workbench/services/view';
