import { MenuItem, MenuSeparator, MobileMenuSub } from '@ofuro/component';
import { sortPagesByDate } from '@ofuro/core/desktop/pages/workspace/detail-page/tabs/journal';
import {
  type DocRecord,
  DocService,
  DocsService,
} from '@ofuro/core/modules/doc';
